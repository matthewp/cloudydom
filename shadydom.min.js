...
if(d.composed||-1<d.composedPath().indexOf(this))if(d.eventPhase===Event.BUBBLING_PHASE&&d.target===d.relatedTarget)d.stopImmediatePropagation();else if(b.handleEvent)b.handleEvent(d);else return b(d)};b.__eventWrappers.push({node:this,type:a,capture:d,once:e,passive:f,wrapperFn:g});nonBubblingEventsToRetarget$$module$$src$patch_events[a]?(this.__handlers=this.__handlers||{},this.__handlers[a]=this.__handlers[a]||{capture:[],bubble:[]},this.__handlers[a][d?"capture":"bubble"].push(g)):module$$src$native_methods.addEventListener.call(this,
a,g,c)}}
